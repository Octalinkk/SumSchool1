...
class Game:
    ...
    #TODO FAIRE UNE FONCTION QUI CREE DU BRUIT POUR EFFECTUER LE FOND DE L'ESPACE
        ...
        if progress < 0.5:
            ...
            pygame.draw.polygon(
                ...
                (progress * 2 * randomR * random.uniform(0, 1),
                 ...
                 progress * 2 * randomB),
                [(spiralX + random.uniform(-1, -0.5), spiralY),
                 (spiralX + random.uniform(0.5, 1), spiralY + random.uniform(1, 2)),
                 (spiralX + random.uniform(1, 2), spiralY + random.uniform(0, 1))]
            )
        else:
